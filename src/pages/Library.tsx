    ...
    return (
      <div className="min-h-screen bg-sand flex flex-col items-center justify-center p-4">
         <div className="bg-white p-8 rounded-3xl shadow-soft max-w-md w-full text-center border border-border">
            ...
            <Button onClick={signInWithGoogle} size="lg" className="w-full text-base font-bold h-14 bg-[#EBE2D3] hover:bg-[#DFD5C4] text-[#594236] rounded-xl shadow-sm border border-[#DCD3C3] transition-all hover:scale-[1.02] mb-4">
